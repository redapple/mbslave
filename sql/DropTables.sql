...
DROP TABLE artist_credit CASCADE;
DROP TABLE artist_credit_name CASCADE;
DROP TABLE artist_gid_redirect;
DROP TABLE artist_ipi;
DROP TABLE artist_meta;
DROP TABLE artist_name CASCADE;
...
DROP TABLE release_group CASCADE;
...
DROP TABLE release_name CASCADE;
